          ...
          <div className="container">
            ...
            <div className="col-md-4 order-md-2 mb-4">
                ...
                <ul className="list-group mb-3">
                    <div>
                    <h3 className="text-secondary">No item on the cart</h3>
                    </div>
                      ...
                      <div key={index}>
                        <li className="list-group-item d-flex justify-content-between lh-condensed">
                          ...
                          <button className="btn btn-sm btn-warning" 
                            onClick={() => this.removeFromCart(product)}><span className="fa fa-trash"></span>Remove
                          </button>
                        </li>
                      </div>
                      )} 
                ...
                <form className="needs-validation" noValidate>
                  ...
                  <div className="row">
                    <div className="col mb-3 md-3">
                      ...
                      <select className="form-control" name="role" value={this.state.value} onChange={this.bind} id="country" required>
